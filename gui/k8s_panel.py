...
class K8sPanel(QWidget):
    ...
    def _build_snapshot_tab(self):
        ...
        self.selector = QLineEdit(); self.selector.setPlaceholderText("如 app=core")
        r1.addWidget(self.selector, 2)
        r1.addWidget(QLabel("Pod 名正则"))
        self.pod_filter = QLineEdit(); self.pod_filter.setPlaceholderText("如 core|celery")
    ...
    def _build_yaml_tab(self):
        ...
        self.yaml_name = QLineEdit(); self.yaml_name.setPlaceholderText("如 core-6bc569958d-2ggkx")
